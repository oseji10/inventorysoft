					...
					<div class="modal-dialog" role="document">
					   <div class="modal-content">
						  ...
						  <div class="modal-body">
							 <form method="POST" action="{{route('register_customer.upload')}}" >
								@csrf
								<div class="mb-3">
					...
					<div class="dt-ext table-responsive">
						<table class="display" id="export-button">
							...
							<tbody>
								...
								<tr>
									<td>{{$customer->customer_name ?? null}}</td>
									<td>{{$customer->customer_email ?? null}}</td>
									<td>{{$customer->customer_phone_number ?? null}}</td>
									<td>{{$customer->customer_phone_number_2 ?? null}}</td>
								
									<td>{{$customer->created_at ?? null}}</td>
								</tr>
