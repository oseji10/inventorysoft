					...
					<div class="modal-dialog" role="document">
					   <div class="modal-content">
						  ...
						  <div class="modal-body">
							 <form method="POST" action="{{route('register_manufacturer.upload')}}" >
								@csrf
								<div class="mb-3">
					...
					<div class="dt-ext table-responsive">
						<table class="display" id="export-button">
							...
							<tbody>
								...
								<tr>
									<td>{{$manufacturer->manufacturer_id ?? null}}</td>
									<td>{{$manufacturer->manufacturer_name ?? null}}</td>
									<td>{{$manufacturer->manufacturer_short_name ?? null}}</td>
									<td>{{$manufacturer->manufacturer_address ?? null}}</td>
									<td>{{$manufacturer->status ?? null}}</td>
									<td>{{$manufacturer->created_at ?? null}}</td>
								</tr>
