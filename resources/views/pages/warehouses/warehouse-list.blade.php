					...
					<div class="modal-dialog" role="document">
					   <div class="modal-content">
						  ...
						  <div class="modal-body">
							 <form method="POST" action="{{route('register_warehouse.upload')}}" >
								@csrf
								<div class="mb-3">
					...
					<div class="dt-ext table-responsive">
						<table class="display" id="export-button">
							...
							<tbody>
								...
								<tr>
									<td>{{$warehouse->warehouse_id ?? null}}</td>
									<td>{{$warehouse->warehouse_name ?? null}}</td>
									<td>{{$warehouse->warehouse_short_name ?? null}}</td>
									<td>{{$warehouse->warehouse_address ?? null}}</td>
									<td>{{$warehouse->warehouse_email ?? null}}</td>
									<td>{{$warehouse->warehouse_phone ?? null}}</td>
									<td>{{$warehouse->status ?? null}}</td>
									<td>{{$warehouse->created_at ?? null}}</td>
								</tr>
