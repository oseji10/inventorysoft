					...
					<div class="modal-dialog" role="document">
					   <div class="modal-content">
						  ...
						  <div class="modal-body">
							 <form method="POST" action="{{route('register_supplier.upload')}}" >
								@csrf
								<div class="mb-3">
					...
					<div class="dt-ext table-responsive">
						<table class="display" id="export-button">
							...
							<tbody>
								...
								<tr>
									<td>{{$supplier->supplier_id ?? null}}</td>
									<td>{{$supplier->supplier_name ?? null}}</td>
									<td>{{$supplier->supplier_short_name ?? null}}</td>
									<td>{{$supplier->supplier_address ?? null}}</td>
									<td>{{$supplier->status ?? null}}</td>
									<td>{{$supplier->created_at ?? null}}</td>
								</tr>
