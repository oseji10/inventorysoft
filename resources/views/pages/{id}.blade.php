			...
			@endif
						<form method="POST" action="{{ route('settings.update') }}">
							...
							<div class="mb-3">
								...
								<input class="form-control" type="text"  value="{{App\Models\Settings::select('app_name')->value('app_name')}}">
							</div>

							<div class="mb-3">
								<label class="form-label">CEO Name</label>
								<input class="form-control" type="text"  value="{{App\Models\Settings::select('ceo_name')->value('ceo_name')}}">
							</div>


							<div class="mb-3">
								<label class="form-label">Referral Code</label>
								<input class="form-control" type="text"  value="{{App\Models\Settings::select('referral_code')->value('referral_code')}}">
							</div>


							<div class="mb-3">
								<label class="form-label">Agent Commission</label>
								<input class="form-control" type="text"  value="{{App\Models\Settings::select('agent_commission')->value('agent_commission')}}">
							</div>
							{{-- <div class="mb-3">
