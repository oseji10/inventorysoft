					...
					<div class="modal-dialog" role="document">
					   <div class="modal-content">
						  ...
						  <div class="modal-body">
							 <form method="POST" action="{{route('register_product_type.upload')}}" >
								@csrf
					...
					<div class="dt-ext table-responsive">
						<table class="display" id="export-button">
							...
							<tbody>
								...
								<tr>
									<td>{{$product_type->id ?? null}}</td>
									<td>{{$product_type->product_type_name ?? null}}</td>
									<td>{{$product_type->created_at ?? null}}</td>
								</tr>
