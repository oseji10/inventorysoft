                  ...
                  <td>
                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr>
                          <td>
                            <h3>ODT IMS Software</h3>
                            <img src="{{asset('assets/images/cuba-logo1.png')}}" alt=""></td>
                          <td style="text-align: right; color:#999"><span>Tomorrow's technology today</span></td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 30px"> 
                            ...
                            <p>A new account has been created for you on our the platform. Use the details below to login and change your password:</p>
                    ...
                    <table style="width: 650px; margin: 0 auto; margin-top: 30px">
                      <tbody>       
                        <tr style="text-align: center">
                          <td> 
                            <p style="color: #999; margin-bottom: 0">333 Emeka Anyouku Street, Abuja, 90090999</p>
                            <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a href="#" style="color: #7366ff">Unsubscribe</a></p>
                            <p style="color: #999; margin-bottom: 0">Powered By ODT IMS Ltd.</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
